...
Elm.Browser.make = function (_elm) {
   "use strict";
   _elm.Browser = _elm.Browser || {};
   if (_elm.Browser.values)
   return _elm.Browser.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
      ...
      return function () {
         ...
         _L.fromArray([A2($Html.div,
                      ...
                      _L.fromArray([A2($Html.button,
                                   _L.fromArray([$Html$Attributes.$class("nav--prev")
                                                ,A2($Html$Events.onClick,
                                                address,
                                                PreviousPost)]),
                                   _L.fromArray([$Html.text("Previous Post")]))
                                   ,A2($Html.span,
                                   ...
                                   totalPosts)))]))
                                   ,A2($Html.button,
                                   _L.fromArray([$Html$Attributes.$class("nav--next")
                                                ,A2($Html$Events.onClick,
                                                address,
                                                NextPost)]),
                                   _L.fromArray([$Html.text("Next Post")]))]))]));
      }();
   });
   ...
   var imageDecoder = A2($Json$Decode.at,
   _L.fromArray(["source"]),
   ...
   "height",
   $Json$Decode.$int)));
   var Post = F3(function (a,b,c) {
      return {_: {}
             ,id: a
             ,source: c
             ,title: b};
   });
   var postDecoder = A4($Json$Decode.object3,
   Post,
   A2($Json$Decode.at,
   _L.fromArray(["data","id"]),
   $Json$Decode.string),
   A2($Json$Decode.at,
   _L.fromArray(["data","title"]),
   $Json$Decode.string),
   A2($Json$Decode.at,
   _L.fromArray(["data"
                ,"preview"
   ...
   $Basics.identity,
   imageDecoder)));
   var redditDecoder = A2($Json$Decode.at,
   _L.fromArray(["data"
                ,"children"]),
   $Json$Decode.list(postDecoder));
   var getPosts = $Effects.task($Task.map(LoadPosts)($Task.toMaybe(A2($Http.get,
   redditDecoder,
